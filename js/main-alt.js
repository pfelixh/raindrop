$(document).ready(function() {
	...
	// Instagram API call	
		function nL(latitude, longitude) {
			iCall = "https://api.instagram.com/v1/media/search?lat="+latitude+"&lng="+longitude+"&distance=5600&access_token=213551.c886f2d.0fe3ef38bfd341de86f0629024e0a053";
			$.ajax({
				type: "GET", 
				dataType: "jsonp",
				cache: false,
	...
	// Moves call
	activity(today);
	// Repeat call every 10sec (to refresh location)
	setTimeout(function() {
	    activity(today);
	}, 10000);
	...
	// Insert the first three images after 1.8 sec (instead of after random time interval)
	setTimeout(function() {
	    rainDrop(60);
	    rainDrop(440);
	    rainDrop(820);
